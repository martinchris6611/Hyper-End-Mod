...
public class GuiHighProductionFurnace extends GuiMachine {
	...
	public GuiHighProductionFurnace(EntityPlayer player,
			World world, int x, int y, int z) {
		super(new ContainerHighProductionFurnace(player, world, x, y, z), "highProductionFurnace", player, world, x, y, z);
	}
