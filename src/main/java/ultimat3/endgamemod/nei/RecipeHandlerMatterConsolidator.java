...
public class RecipeHandlerMatterConsolidator extends TemplateRecipeHandler {
	...
	public void loadCraftingRecipes(ItemStack result) {
		...
		for (int i = 0; i < recipe.size(); i++) {
			...
			arecipes.add(new ClassRecipe(recipe.get(i)[0], recipe.get(i)[1],
	...
	public void loadCraftingRecipes(String outputId, Object... results) {
		if (outputId.equals("ExpoTechMatterConsolidator")
				&& getClass() == RecipeHandlerMatterConsolidator.class) {
			for (int i = 0; i < recipe.size(); i++) {
				arecipes.add(new ClassRecipe(recipe.get(i)[0],
