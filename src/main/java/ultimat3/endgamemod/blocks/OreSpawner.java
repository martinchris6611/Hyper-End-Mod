...
public class OreSpawner implements IWorldGenerator {
	...
	private void generateSurface(World world, Random random, int x, int y) {
		...
		this.addOreSpawn(ModBlocks.blockOres, 3, world, random, x, y, 16, 16, 8, 10, 6, 60); // Magnesium
		this.addOreSpawn(ModBlocks.blockOres, 4, world, random, x, y, 16, 16, 1, random.nextInt(1), 2, 50); // Scandium
